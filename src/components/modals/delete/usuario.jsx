...
export default function DeleteUsuarioModal({ currentData, closeModal, renderTable }) {
        ...
        <>
            <div className="page-container modal">
                <div className="page-title">
                    <h1>Deletar usuário {receivedData.nome}</h1>
                    <h2>Todos os campos devem ser preenchidos</h2>
                </div>
                <div className="edit-form-container">
                    <div className="page-filters filters-relatorio-efetivo">
                        <div className="input-container">
                            <p>Tem certeza que deseja deletar este usuário?<br/>Esta ação não pode ser desfeita.</p>
